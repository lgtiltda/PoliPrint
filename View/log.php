    ...
    <header class="masthead" style='margin-top:-50px;'>
        <div class="container">
            <div class="masthead-subheading" style="color:#000; background-color: rgb(255, 255, 255, 0.5);">
                ...
                Modernização Logística com Equipamentos Outsourcing! Aprimoramos todos os passos, desde a organização até a entrega, tornando o processo mais eficiente e fluido.
                </b></BR></br>
            </div>
