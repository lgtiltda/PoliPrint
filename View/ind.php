    ...
    <header class="masthead" style='margin-top:-50px;'>
        <div class="container">
            <div class="masthead-subheading" style="color:#000; background-color: rgb(255, 255, 255, 0.5);">
                </BR><b>Potencialize a Produção Industrial com Outsourcing de Equipamentos. Nossa tecnologia robusta otimiza desde a fabricação até o backoffice, impulsionando cada etapa do processo!</b></BR></br>
            </div>
