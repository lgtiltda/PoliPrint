    ...
    <header class="masthead" style='margin-top:-50px;'>
        <div class="container">
            <div class="masthead-subheading" style="color:#000; background-color: rgb(255, 255, 255, 0.5);">
                </BR><b>Experiência ampla no Outsourcing para o Governo. Parceiros das principais instituições públicas do Brasil, estamos preparados para superar desafios complexos com excelência!</b></BR></br>
            </div>
