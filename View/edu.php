    ...
    <header class="masthead" style='margin-top:-50px;'>
        <div class="container">
            <div class="masthead-subheading" style="color:#000; background-color: rgb(255, 255, 255, 0.5);">
                ...
                Transforme a Educação com o Outsourcing! Atualize sua escola com equipamentos e soluções que proporcionam a melhor experiência em sala de aula, secretaria, campus e administração
            </b></BR></br>
            </div>
