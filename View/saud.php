    ...
    <header class="masthead" style='margin-top:-50px;'>
        <div class="container">
            <div class="masthead-subheading" style="color:#000; background-color: rgb(255, 255, 255, 0.5);">
                ...
                Excelência em Outsourcing de Equipamentos para Saúde! Integre tecnologia de ponta para otimizar pacientes, equipe médica e processos administrativos, tudo em um só lugar.
                </b></BR></br>
            </div>
